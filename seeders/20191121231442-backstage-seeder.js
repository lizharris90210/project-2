...
console.log(`${gradient.summer("/seeders/20191121231442-backstage-seeder.js loaded")}\n=========================\n`);
      ...
      [
        {
          ...
          backstage_pic:
            "http://i1.sndcdn.com/artworks-000603414199-auml3z-original.jpg",
          ...
          experience:
            "2 tours with Ozzy, 1 tour with Kelly Clarkson, 3 tours with Ariana Grande",
          genres: "any"
        },
        {
        ...
        },
        {
          ...
          equipment: "manager",
          experience:
            "managed Jazz Stars 2 years, managed Blue Hounds 3 years, currently managing Dark Blue and Sad",
          genres: "jazz, blues"
        }
      ],
      {}
